\chapter{The Hot Big Bang model}
...
After decoupling the collision term of neutrinos is negligible and thus the number of neutrinos is conserved: this shows that neutrinos then starts to cool as 
