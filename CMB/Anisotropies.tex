...
\begin{align*}
    h_{\boldsymbol{\times}}&=-\sqrt\frac{3}{2}(h^{(+)}+h^{(-)}),\qquad &h^{(+)}&=-\frac{1}{\sqrt{6}}(h_{\boldsymbol{\times}}-ih_{\boldsymbol{+}}),\\ h_{\boldsymbol{+}}&=-i\sqrt\frac{3}{2}(h^{(+)}-h^{(-)}),\qquad &h^{(-)}&=-\frac{1}{\sqrt{6}}(h_{\boldsymbol{\times}}+ih_{\boldsymbol{+}}).
\end{align*}
