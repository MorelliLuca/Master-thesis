    ...
    \begin{tikzpicture}[scale=.8]
        \begin{axis}[
            ...
            legend style={font=\small}
             ...
             % Plot for t_H (radiation domination)
             \addplot[
                domain=1e4:1e10,
                samples=200,
                thick,
            ...
            % Plot for t_H (matter domination)
            ...
            \addplot[
                ...
                thick,
                densely dashed
            ] {1.9e26 * (3*0.022/(0.05*0.7^2)) *  (1 + x)^(-2.5)};
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Comparison of the timescales of Compton scattering, Bremsstrahlung and double Compton scattering with the expansion of the universe as a function of redshift. When each timescale becomes larger than $t_H$ (double line in the graph) the corresponding process becomes inefficient.}
