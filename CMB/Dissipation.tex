...
\end{equation}
where $W_a$ is the window function of the distortion a $a$. This decomposition allows us to better understand at which scales perturbation dissipation more efficiently sources distortions. 
